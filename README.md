...
| `/claude-warp-new-hook "description"` | Scaffold a hook (10 patterns): verify-before-stop, destructive-block, audit-log, subagent-chain, security-scan, evidence-gate, review-gate, kill-switch, steer, intent-gate |
