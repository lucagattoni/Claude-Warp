...
allowed-tools — see `/claude-warp-new-hook`) and **out-of-process** controls (the OS user,
container, or network boundary the loop runs inside). L3 loops need both. Full detail:
